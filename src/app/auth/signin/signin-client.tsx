        ...
        <ScaleIn>
          <Card className="border-white/[0.08] overflow-hidden">
            ...
            <CardContent className="space-y-5">
              ...
              <FadeIn delay={0.3}>
                {sent ? (
                  <div className="space-y-3 rounded-lg border border-neon-cyan/30 bg-neon-cyan/5 px-4 py-4">
                    <div className="flex items-center gap-2 text-neon-cyan">
                      <CheckCircle className="h-5 w-5" />
                      <span className="font-semibold">Check your email</span>
                    </div>
                    <p className="text-sm text-muted-foreground">
                      We sent a sign-in link to <strong className="text-white">{email}</strong>. Click the link to sign in.
                    </p>
                    <button
                      type="button"
